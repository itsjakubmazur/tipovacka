      ...
      >
        ...
        >
          ...
          <div
            style={{
              display: "flex",
              // Satori has no real baseline alignment - align bottoms and
              // lift the small word by the difference in descent space
              alignItems: "flex-end",
              marginTop: 6,
              color: "#FFD400",
              fontWeight: 800,
          ...
          >
            ...
            <span style={{ fontSize: 48, lineHeight: 1, marginLeft: 14, paddingBottom: 19 }}>
