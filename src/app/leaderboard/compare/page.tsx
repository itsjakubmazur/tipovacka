    ...
    return (
      <div className="flex flex-col gap-4 px-4 py-8">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex flex-col items-center gap-1 rounded-xl border border-neutral-200 bg-white p-4 shadow-lg shadow-black/20 dark:border-neutral-700 dark:bg-neutral-800 dark:shadow-black/60">
      ...
      <div className="flex flex-col gap-2">
        {eventsInSeason.map((event) => {
          ...
          return (
            <div
              key={event.id}
              className="flex items-center justify-between rounded-xl border border-neutral-200 bg-white p-3 text-sm shadow-lg shadow-black/20 dark:border-neutral-700 dark:bg-neutral-800 dark:shadow-black/60"
            >
