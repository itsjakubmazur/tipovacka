  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="glass-surface border relative flex max-h-[75vh] flex-col rounded-t-2xl border-t bg-white lg:w-full lg:max-w-sm lg:rounded-2xl lg:border dark:bg-neutral-900"
      >
