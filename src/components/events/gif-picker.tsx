  ...
  return (
    <div className="fixed inset-0 z-[60] flex flex-col justify-end" onClick={onClose}>
      ...
      <div
        ...
        className="animate-modal-panel relative flex max-h-[70vh] flex-col overflow-hidden rounded-t-2xl border-t border-white/45 bg-white/60 backdrop-blur-2xl shadow-2xl shadow-black/40 dark:border-neutral-700/45 dark:bg-neutral-900/60"
      >
