          ...
          <div className="relative flex shrink-0 items-center gap-1">
            ...
            {boldHelpOpen && (
              <>
                ...
                />
                <div className="glass-panel absolute right-0 top-full z-20 mt-1.5 w-60 max-w-[calc(100vw-2rem)] rounded-xl border p-3 text-xs leading-relaxed text-neutral-600 dark:text-neutral-300">
